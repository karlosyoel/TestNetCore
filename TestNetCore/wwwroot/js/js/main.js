...
// three = THREE;
// import Stats from '../js/vendor/mrdoob/three.js/examples/jsm/libs/stats.module.js';
...
// import { FirstPersonControls } from '../js/three.js/examples/jsm/controls/FirstPersonControls.js';

import { GLTFLoader } from '../vendor/mrdoob/three.js/examples/jsm/loaders/GLTFLoader.js';
// import { Lensflare, LensflareElement } from './js/three.js/examples/jsm/objects/Lensflare.js';
...
function init() {
    ...
    // const loader = new THREE.TextureLoader();
    const textureSphereBg = loader.load('./js/imgs/bg3-je3ddz.jpg');
    const texturenucleus1 = loader.load('./js/imgs/ee7eb380d570674fb1a47c326c8687b2.jpg');
    const texturenucleus = loader.load('./js/imgs/earth.jpeg');
    const textureStar = loader.load("./js/imgs/p1-g3zb2a.png");
    const texture1 = loader.load("./js/imgs/p2-b3gnym.png");  
    const texture2 = loader.load("./js/imgs/p3-ttfn70.png");
    const galaxias = loader.load("./js/imgs/p4-avirap.png");

    planetas.push(loader.load("./js/imgs/1280px-Mars_Viking_MDIM21_1km_plus_poles.jpg"));
    planetas.push(loader.load("./js/imgs/big_d28026d0bc.jpg"));
    planetas.push(loader.load("./js/imgs/earth.jpeg"));
    planetas.push(loader.load("./js/imgs/ee7eb380d570674fb1a47c326c8687b2.jpg"));
    planetas.push(loader.load("./js/imgs/jupiter-planet-texture-background-elements-260nw-1549145969.jpg"));
    planetas.push(loader.load("./js/imgs/mars0_src_smaller.jpg"));
    planetas.push(loader.load("./js/imgs/Rammed-Earth-Works-Stadium-TechCenter-8543.jpg"));
    planetas.push(loader.load("./js/imgs/star-nc8wkw.jpg"));
    // console.log(planetas[0])
    // planetas.push(loader.load("./js/imgs/texture-surface-jupiter-elements-this-260nw-1332420641.jpg"));
    // planetas.push(loader.load("./js/imgs/textured-surface-planet-jupiter-closeuptexture-260nw-1701426835.jpg"));
    // planetas.push(loader.load("./js/imgs/surface-mars-craters-impact-on-260nw-2043301529.jpg"));
    // planetas.push(loader.load("./js/imgs/moon-surface-seamless-texture-background-260nw-1827119627.jpg"));
    ...
    //loaderGLTFL.load( '../js/ship/space craft.glb', function ( gltf ) {
...
// }
    ...
    controls.rollSpeed = 0.005;//Math.PI / 60;
